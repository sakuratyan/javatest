...
public class Vec3 {
    ...
    // 向量数乘
    public static Vec3 Scale(Vec3 a, float c) {
    ...
    public float length() {
        return (float) Math.sqrt(
                ...
                Math.pow((double) e[0], 2.0) + Math.pow((double) e[1], 2.0) + Math.pow((double) e[2], 2.0));
    }
    ...
    public Vec3 cross(Vec3 v) {
        return new Vec3(e[1] * v.z() - e[2] * v.y(), e[2] * v.x() - e[0] * v.z(), e[0] * v.y() - e[1] * v.x());
    }
    ...
    /**
     * 这个矩阵只是调节i j k 系数大小的，不完整。 左右顺序无所谓
     * 
     * @param v
     * @return
     */
